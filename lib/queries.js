...
/**
 * All books, sorted by displayOrder then title.
 */
export const ALL_BOOKS_QUERY = `
  *[_type == "book"] | order(displayOrder asc, title asc) {
    _id,
    title,
    author,
    slug,
...
/**
 * All journals, sorted by displayOrder then title.
 */
export const ALL_JOURNALS_QUERY = `
  *[_type == "journal"] | order(displayOrder asc, title asc) {
    _id,
    title,
    publisher,
    slug,
...
export const ALL_CAREERS_QUERY = `
  *[_type == "career"] | order(displayOrder asc, publishDate desc) {
    _id,
    title,
    department,
    employmentType,
